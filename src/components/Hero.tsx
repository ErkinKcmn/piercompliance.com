    ...
    <section id="home" className="relative bg-gradient-to-br from-primary via-primary-dark to-blue-900 text-white py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="absolute inset-0 z-0 pointer-events-none" style={{background: 'rgba(30, 41, 59, 0.35)'}} />
          <div className="relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
              <span className="text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)]">
                {t.heroTitle}
              </span>
            </h1>
            
            <p className="text-xl md:text-2xl lg:text-3xl mb-12 text-white leading-relaxed max-w-4xl mx-auto font-medium drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)]">
              {t.heroSubtitle}
            </p>
